...
EVENT_PAYLOAD_PORT_UPDATE = {
    ...
    'fixed_ips': [{'subnet_id': 'f68b9dd3-4cb5-46aa-96b1-f9c8a7abc3aa', 'ip_address': '172.16.4.2'}], 'name': 'test',
...
PORT_DOCUMENT = {
    ...
    "id": "16620a58-c48c-4195-b9c1-779a8ba2e6f8",
    "id_path": "/Mirantis-Liberty-CL/Mirantis-Liberty-CL-projects/75c0eb79ff4a42b0ae4973c8375ddf40/75c0eb" +
    ...
    "name": "123",
    "name_path": "/Mirantis-Liberty-CL/Projects/OSDNA-project/Networks/osdna-met4/Ports/fa:16:3e:d7:c5:16",
