...
<Project ToolsVersion="4.0" DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <ItemGroup>
    <Content Include="examples\3dtree.html" />
    ...
    <Content Include="examples\pageBoundsConstraints.png" />
    <Content Include="examples\smallworldwithgroups.png" />
    ...
    <Content Include="examples\pageBoundsConstraints.html" />
    <Content Include="examples\smallworldwithgroups.html" />
    ...
    <Content Include="examples\dotpowergraph.html" />
    <Content Include="examples\vhybridize.html" />
    ...
    <TypeScriptCompile Include="examples\3dtree.ts" />
    ...
    <TypeScriptCompile Include="examples\dotpowergraph.ts" />
    <TypeScriptCompile Include="examples\vhybridize.ts" />
    <TypeScriptCompile Include="src\batch.ts" />
    <TypeScriptCompile Include="src\layout.ts" />
    <TypeScriptCompile Include="src\d3adaptor.ts" />
    ...
    <TypeScriptCompile Include="src\handledisconnected.ts" />
    <TypeScriptCompile Include="src\layout3d.ts" />
    ...
    <TypeScriptCompile Include="src\rbtree.ts" />
    ...
    <Content Include="examples\graphdata\state_machine.json" />
    <None Include="examples\graphdata\test1.json" />
    <TypeScriptCompile Include="test\apitests.ts" />
    <TypeScriptCompile Include="test\qunit.d.ts" />
  </ItemGroup>
  <ItemGroup>
