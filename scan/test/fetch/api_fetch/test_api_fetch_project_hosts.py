...
class TestApiFetchProjectHosts(TestFetch):
    ...
    def test_add_host_type_with_existent_host_type(self):
        fetch_host_os_details = self.fetcher.update_host_os_details
        self.fetcher.update_host_os_details = MagicMock()
        ...
        self.fetcher.update_host_os_details = fetch_host_os_details
    ...
    def test_fetch_host_os_details(self):
        ...
        doc = {'host': 'host1'}
        self.fetcher.update_host_os_details(doc)
