...
from scan.fetchers.cli.cli_fetch_vedges_vpp import CliFetchVedgesVpp
from scan.test.fetch.cli_fetch.test_data.cli_fetch_vedges_vpp import *
        ...
        test_cases = [
            ...
            },
            {
                ...
                "err_msg": "Can't get [] when the host of the " +
                           "vedge doesn't exist in initial_data"
            },
            {
                "version": VERSION,
                "interfaces": INTERFACES,
