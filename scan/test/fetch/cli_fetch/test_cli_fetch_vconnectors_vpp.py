...
from scan.fetchers.cli.cli_fetch_vconnectors_vpp import CliFetchVconnectorsVpp
from scan.test.fetch.cli_fetch.test_data.cli_fetch_vconnectors_vpp import *
