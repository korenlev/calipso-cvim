...
from listen.test.event_based_scan.test_data.event_payload_subnet_add \
    import EVENT_PAYLOAD_SUBNET_ADD, EVENT_PAYLOAD_REGION, NETWORK_DOC, HOST_DOC, PORT_DOC
