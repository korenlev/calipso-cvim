...
from listen.events.event_router_update import EventRouterUpdate
from listen.test.event_based_scan.test_data.event_payload_router_update \
    import EVENT_PAYLOAD_ROUTER_UPDATE, ROUTER_DOCUMENT, EVENT_PAYLOAD_ROUTER_SET_GATEWAY, \
    EVENT_PAYLOAD_ROUTER_DEL_GATEWAY, ROUTER_VSERVICE, PORT, HOST_DOC
