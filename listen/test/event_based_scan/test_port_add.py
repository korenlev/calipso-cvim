...
from listen.test.event_based_scan.test_data.event_payload_port_add \
    import EVENT_PAYLOAD_PORT_INSTANCE_ADD, NETWORK_DOC, INSTANCE_DOC, INSTANCES_ROOT, \
    VNIC_DOCS, INSTANCE_DOCS, PORTS_FOLDER, PORT_DOC
...
class TestPortAdd(TestEvent):
    ...
    def test_handle_port_add(self,
        ...
        # Assert that port has been added to initial_data
